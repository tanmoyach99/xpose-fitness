      ...
      <div style={{ backgroundColor: "lightsteelblue", position: "absolute" }}>
        ...
        >
          ...
          <p className="text-secondary">
            ...
            odio voluptatem ad blanditiis numquam adipisci neque, perferendis in
            odit dignissimos cumque architecto inventore quae ut recusandae quam
            quidem nisi, aspernatur nobis dolore eius aliquam quos voluptatibus.
            Dicta, dignissimos optio facilis aliquam itaque libero nesciunt
            placeat commodi asperiores vero quos?
          </p>
        </div>
      </div>
    </div>
